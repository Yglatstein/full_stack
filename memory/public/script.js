let imagesPaths = ['../public/libs/images/img1.png', '../public/libs/images/img2.png', '../public/libs/images/img3.png', '../public/libs/images/img4.png', '../public/libs/images/img5.png', '../public/libs/images/img6.png'];
let matchesFound = [];
let openImgs = 0, milliseconds = 0, timeout = false, timerOn = false;
let selected1, selected2, isWin;
...
function shuffle_images(imagesPaths) {
    let newImagesPathes = [];
...
function add_img_listenner(img) {
...
function set_images(imagesPaths) {
...
function check_match(selected1, selected2) {
